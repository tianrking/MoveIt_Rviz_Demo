...
struct has_fixed_size<moveit_task_constructor_msgs::msg::SubTrajectory>
  : std::integral_constant<bool, has_fixed_size<moveit_msgs::msg::PlanningScene>::value && has_fixed_size<moveit_msgs::msg::RobotTrajectory>::value && has_fixed_size<moveit_task_constructor_msgs::msg::SolutionInfo>::value> {};

template<>
struct has_bounded_size<moveit_task_constructor_msgs::msg::SubTrajectory>
  : std::integral_constant<bool, has_bounded_size<moveit_msgs::msg::PlanningScene>::value && has_bounded_size<moveit_msgs::msg::RobotTrajectory>::value && has_bounded_size<moveit_task_constructor_msgs::msg::SolutionInfo>::value> {};
