...
static rosidl_typesupport_introspection_c__MessageMember moveit_task_constructor_msgs__msg__SolutionInfo__rosidl_typesupport_introspection_c__SolutionInfo_message_member_array[5] = {
  {
    "id",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_task_constructor_msgs, msg, SolutionInfo)() {
  moveit_task_constructor_msgs__msg__SolutionInfo__rosidl_typesupport_introspection_c__SolutionInfo_message_member_array[4].members_ =
