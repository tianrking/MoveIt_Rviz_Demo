...
static rosidl_typesupport_introspection_c__MessageMember moveit_task_constructor_msgs__msg__SubTrajectory__rosidl_typesupport_introspection_c__SubTrajectory_message_member_array[3] = {
  {
    "info",  // name
